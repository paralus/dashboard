  ...
  return (
    ...
    >
      <Grid item>
        <Paper className={classes.titleCard}>
          <h2 className="h2 mb-0">
            <T.span text="groups.add_users.widget_labels.available_users" />
          </h2>
          <Button
            size="small"
            variant="contained"
          ...
          >
            <T.span text="groups.add_users.widget_button_labels.add_to_group" />
      ...
      <Grid item>
        <Paper className={classes.titleCard}>
          <h2 className="h2 mb-0">
            <T.span text="groups.add_users.widget_labels.group_users" />
          </h2>
          <Button
            size="small"
            variant="contained"
          ...
          >
            ...
            <T.span text="groups.add_users.widget_button_labels.remove_from_group" />
          </Button>
        </Paper>
