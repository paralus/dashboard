  ...
  return (
    ...
    >
      <Grid item>
        <Paper className={classes.titleCard}>
          <h2 className="h2 mb-0">
            <T.span text="users.add_to_group.widget_labels.available_groups" />
          </h2>
          <Button
            size="small"
            variant="contained"
          ...
          >
            <T.span text="users.add_to_group.widget_button_labels.add_groups" />
      ...
      <Grid item>
        <Paper className={classes.titleCard}>
          <h2 className="h2 mb-0">
            <T.span text="users.add_to_group.widget_labels.add_to_groups" />
          </h2>
          <Button
            size="small"
            variant="contained"
          ...
          >
            ...
            <T.span text="users.add_to_group.widget_button_labels.remove_groups" />
          </Button>
        </Paper>
